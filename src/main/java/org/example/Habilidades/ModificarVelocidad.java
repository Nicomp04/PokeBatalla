...
public class ModificarVelocidad extends Modificacion{
    ...
    public ModificarVelocidad(int id, String nombre, int usosDisponibles, int estadistica, int valor, String tipo) {
    ...
    protected Object clone() throws CloneNotSupportedException {
        ModificarVelocidad clonedAtaque = (ModificarVelocidad) super.clone();
    ...
    public Habilidad clonar() {
        try {
            return (ModificarVelocidad) clone();
