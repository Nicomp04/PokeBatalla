        ...
        try {
            ...
            for (int i = 0; i < jsonHabilidades.length(); i++) {
                ...
                if (estilo.equals("Ataque")) {
                    ...
                    habilidad = new ModificarAtaque(id, nombre, usos, estadistica, valor);
                } else if (estilo.equals("ModificacionDeVida")) {
                    habilidad = new ModificarHp(id, nombre, usos, estadistica, valor);
                } else if (estilo.equals("ModificacionDeDefensa")) {
                    habilidad = new ModificarDefensa(id, nombre, usos, estadistica, valor);
                } else if (estilo.equals("ModificacionDeVelocidad")) {
                    habilidad = new ModificarVelocidad(id, nombre, usos, estadistica, valor);
                } else{
